...
def parse_arguments():  
    ...
    parser.add_argument("retexfile", type=str)
    ...
    retexfile = args.retexfile
    dotfile = args.dotfile
    
    return graph, textfile, retexfile, dotfile

#parse the command line arguments
graph, textfile, retexfile, dotfile = parse_arguments()
...
result = CITUP_Acessment(G_Dir,new_mutation_in_clone,n_mutation,dot=dotfile,muta=retexfile) 
