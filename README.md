...
#### Output:
the simulated data of each tool will be saved in folders: Data_MIPUP, Data_LICHeE, Data_AncesTree, Data_CITUP, Data_Treeomics, respectively. In each folder, datasets are catogorised based on their sample sizes and read coverages, and each catogory is saved in a folder named in the format: samplesize_readcoverage. 
...
here, 5_100_1_G_Dir.gpickle contains tree topology of the 1st dataset of 5 samples and read coverage 100, 5_100_1.txt contains clonal information of the same dataset, Data_MIPUP_1_ip_columns.csv and Data_MIPUP_1_ip_tree.dot are the outputs of MIPUP of the 1st dataset.
