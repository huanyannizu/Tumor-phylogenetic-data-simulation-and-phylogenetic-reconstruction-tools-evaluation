This repository contains algorithms to simulate tumor phylogenetic data and to evaluate phylogenetic reconstruction tools (including MIPUP, LICHeE, AncesTree, CITUP, Treeomics) from
